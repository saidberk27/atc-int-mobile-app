...
class _WorkerFormsState extends State<WorkerForms> {
  ...
  final TextEditingController _partsMustChange = TextEditingController();
  final TextEditingController _otherComments = TextEditingController();
  final TextEditingController _vehicleHealthStatus = TextEditingController();
  final TextEditingController _serviceLocation = TextEditingController();
    ...
    List<Step> formSteps = <Step>[
      ...
      Step(
        ...
        content: textFormField(
            hintText: "Parçaları Giriniz...", controller: _partsMustChange),
      ),
      Step(
        title: const Text('Araç Ömür Durumu'),
        content: textFormField(
            hintText: "Durum Giriniz... ", controller: _vehicleHealthStatus),
      ),
      Step(
        ...
        content: Column(
          children: [
            textFormField(
                hintText: "Yorumları Giriniz...", controller: _otherComments),
